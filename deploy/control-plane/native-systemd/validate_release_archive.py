...
REQUIRED_FILES = {
    ...
    "deploy/control-plane/native-systemd/legacy_adoption_descriptor.py",
    "deploy/control-plane/native-systemd/legacy_rollback_descriptor.py",
    "deploy/control-plane/native-systemd/media-tools.sha256",
    "deploy/control-plane/native-systemd/normalize_offline_python_runtime.sh",
    "deploy/control-plane/native-systemd/normalize_legacy_unit.sh",
    "deploy/control-plane/native-systemd/offline-python-archive.sha256",
    "deploy/control-plane/native-systemd/offline-python-legacy-drift-tree.sha256",
    "deploy/control-plane/native-systemd/offline-python-tree.sha256",
